...
class CelebVoiceManager():
    ...
    def _load_from_json(self, celebrities30s_json):
        ...
        if not os.path.exists(celebrities30s_json):
            logger.debug(f"[abus_voice_celeb.py] _load_from_json - celebrities file not found, skipping: {celebrities30s_json}")
            return
        ...
        try:
            ...
            logger.warning(f"[abus_voice_celeb.py] _load_from_json - {e}")
