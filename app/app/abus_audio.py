...
class AbusAudio():
    ...
    def trim_silence_file(input_file, output_file, start_silence_threshold=-50.0, end_silence_threshold=-50.0, chunk_size=10, padding_duration=100):
        ...
        try:
            ...
            # Explicitly pass format based on output extension to avoid pydub defaulting to mp3
            ...
            logger.warning(f"[abus_audio.py] trim_silence_file - issue: {e}")
            # Fallback: copy input to output if trimming fails
            import shutil
