...
def _run_ffmpeg_cmd(command: str):
    """Run an ffmpeg command via os.system. Wrapper for consistent logging."""
    logger.debug(f'[abus:_run_ffmpeg_cmd] {command}')
    os.system(command)
...
def ffmpeg_mix_audio(audio_path1: str, audio_path2: str, output_path: str, audio_gain1: float, audio_gain2:float, audio_format: str = "flac"):   
    ...
    if audio_format=="flac":
        ...
        encoding_options = "-ar 48000 -b:a 320k -ac 2"
    elif audio_format=="ogg":
...
def ffmpeg_to_mono(input_path: str, left_path: str, right_path: str, audio_format: str = "wav"):
    ...
    if audio_format=="flac":
        ...
        encoding_options = "-ar 48000 -b:a 320k"
    elif audio_format=="ogg":
